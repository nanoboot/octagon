 ...
 * @since 0.1.0
 */
public class ActionTypeTypeHandler implements TypeHandler<ActionType> {

    public ActionType getResult(ResultSet rs, String param) throws SQLException {
    ...
    public ActionType getResult(CallableStatement cs, int col) throws SQLException {
        return ofString(cs.getString(col));
    }

    public void setParameter(PreparedStatement ps, int paramInt, ActionType paramType, JdbcType jdbcType)
            throws SQLException {
    ...
    private ActionType ofString(String s) {
        return s == null ? null : ActionType.valueOf(s);
    }
}
