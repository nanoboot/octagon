 ...
 * @since 0.1.0
 */
public class OctagonInput extends Input {
    public OctagonInput(String type, String name, String id, String value) {
        this(type, name, id, value, false);
    }
    public OctagonInput(String type, String name, String id, String value, boolean readonly) {
        ...
        if (readonly) {
            this.add(new Attribute("readonly", "readonly"));
        }
        if (value != null) {
