...
import org.nanoboot.octagon.plugin.actionlog.impl.repos.ActionLogRepositoryImplSQLiteMyBatis;
 ...
 * @since 0.1.0
 */
public class ActionLogPlugin implements Plugin {
    @Getter
    ...
    public String init(Properties propertiesConfiguration) {
        ...
        pluginStub
                .registerEntity(
                        "system",
                        ActionLog.class,
                        ActionLogMapper.class,
                        ActionLogRepositoryImplSQLiteMyBatis.class, 10);
