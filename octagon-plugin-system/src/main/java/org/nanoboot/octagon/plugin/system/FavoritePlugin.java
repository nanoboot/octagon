...
import org.nanoboot.octagon.plugin.favorite.impl.repos.FavoriteRepositoryImplSQLiteMyBatis;
 ...
 * @since 0.1.0
 */
public class FavoritePlugin implements Plugin {
    @Getter
    ...
    public String init(Properties propertiesConfiguration) {
        ...
        pluginStub
                .registerEntity(
                        ...
                        FavoriteRepositoryImplSQLiteMyBatis.class,
                        40);
