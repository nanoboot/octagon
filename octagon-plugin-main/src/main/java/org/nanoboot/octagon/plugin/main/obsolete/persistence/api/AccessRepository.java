...
import org.nanoboot.octagon.plugin.main.obsolete.classes.Access;
...
public interface AccessRepository {
    /**
     * Finds access by its id.
     * @param id id to use
     * @return access instance
     */
    Access findAccessById(UUID id);
     ...
     */
    void deleteAccessRight(Access access);
