 ...
 * @since 0.1.0
 */
public class QueryRepositoryImplSQLiteMyBatis extends RepositoryImpl<Query> implements QueryRepository {
    public QueryRepositoryImplSQLiteMyBatis(MapperApi<Query> mapper, Class type) {
        super(mapper, type);
    }
}
