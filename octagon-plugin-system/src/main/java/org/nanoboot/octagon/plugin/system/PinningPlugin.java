...
import org.nanoboot.octagon.plugin.pinning.impl.repos.PinningRepositoryImplSQLiteMyBatis;
 ...
 * @since 0.1.0
 */
public class PinningPlugin implements Plugin {
    @Getter
    ...
    public String init(Properties propertiesConfiguration) {
        ...
        pluginStub
                .registerEntity(
                        ...
                        Pinning.class,
                        PinningMapper.class,
                        PinningRepositoryImplSQLiteMyBatis.class, 20);
