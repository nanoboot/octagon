...
package org.nanoboot.octagon.plugin.main.persistence.impl.typehandlers;
...
import org.nanoboot.octagon.plugin.main.classes.Role;
...
public class RoleTypeHandler implements TypeHandler<Role> {
    ...
    @Override
    public Role getResult(ResultSet rs, int i) throws SQLException {
    ...
    private Role ofString(String s) {
