 ...
 * @since 0.1.0
 */
public class SqlQueryRepositoryImplSQLiteMyBatis extends RepositoryImpl<SqlQuery> implements SqlQueryRepository {
    public SqlQueryRepositoryImplSQLiteMyBatis(MapperApi<SqlQuery> mapper, Class type) {
        super(mapper, type);
    }
}
